...
1. Download [Tableau Public](https://public.tableau.com/) or Tableau Desktop (free to view).
2. Clone this repo:
   ```bash
...
Alternatively, publish the workbook to [Tableau Public](https://public.tableau.com/) and link it here:
